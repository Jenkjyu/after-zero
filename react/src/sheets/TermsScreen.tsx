...
// 参照CLAUDE.md里renderReportScreen()那条先例——内部名字没跟着改，不影响功能，只是历史
  ...
  return (
    <div className={"subpage" + (isOpen ? " open" : "")} id="termsScreen">
      ...
      <div className="subpage-body terms-body">
        ...
        <h3>一、服务内容和会员权益</h3>
        <ol>
          <li>Premium 是本产品目前唯一的付费会员等级，开通后可使用：云备份、AI 债务顾问、高级统计报表导出（Excel/PDF）等功能。具体权益范围以您使用时应用内实际展示为准，我们可能根据产品发展调整全部或部分权益，调整会在应用内公告。</li>
