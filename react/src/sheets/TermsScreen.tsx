  ...
  return (
    <div className={"subpage" + (isOpen ? " open" : "")} id="termsScreen">
      ...
      <div className="subpage-body terms-body">
        ...
        <ol>
          <li><strong>当前状态说明：</strong>本产品目前提供买断（一次性）、包月、包年三种购买方式的入口，<strong>但截至本协议生效之日，尚未接入真实的支付渠道，应用内展示的价格为占位展示，暂不支持实际付费购买</strong>。在正式开通真实支付前，您可能通过我们不定期发放的兑换码获得体验资格。</li>
          <li>兑换码获得的会员资格用于产品体验，我们有权在发现兑换码被不当传播、滥用等情况时收回相应资格，且无需向您提供补偿。</li>
          <li>待本产品正式接入真实支付渠道后，我们会更新本协议，明确届时的购买流程、买断/包月/包年各自的有效期规则，并以应用内实际展示的价格、支付方式为准。</li>
